...
class BlogController extends AdminController
{
    ...
    public function actionCreate()
    {
        ...
        if($blog_article_model->load(Yii::$app->request->post())){
            ...
            {
                $blog_article_model = $this->get_blog_edit_service_repo()->add_blog_article($blog_article_model, Yii::$app->request->post('image'));
                Yii::$app->session->addFlash('info', 'Post add. <a href="'. Url::to(['/blog'], true) .'/'.$blog_article_model->alias .'" >View</a>');
