...
$this->title = $country_model->title;
    ...
    <div class="welcome-block-inner single-header__content">
        ...
        <div class="content-block-wrapper">
            <div class="content-block-inner">
                <h1>
                    Flights to <span><?= Html::encode($country_model->name); ?></span>
                </h1>
                <h2>
                    <?= Html::encode($country_model->title); ?>
                </h2>
            </div>
        </div>
            ...
            <div class="inner">
                <div class="left-block">
                    ...
                    <div class="column column-1">
                        ...
                        <div class="r">
                            from <span class="new">$<?= Html::encode($country_model->business_class_price); ?></span>
                        </div>
                    ...
                    <div class="column column-2">
                        ...
                        <div class="r">
                            from <span class="new">$<?= Html::encode($country_model->first_class_price); ?></span>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div>
        ...
        <div class="columns">
            <div id="content" class="column">
                <div class="summary-block">
                    <?php echo $country_model->summary; ?>
                </div>
                <div class="body">
                    <?php echo $country_model->body; ?>
                </div>
                <div class="sections">
                    <div class="column column-1">
                        <div class="title">
                    ...
                    <div class="column column-2">
                        <div class="title">
                            Top <?= Html::encode($country_model->name); ?> Destination
                        </div>
                        <div class="description">
                            <ul>
...
<div class="bottom-block-wrapper">
    <div class="bottom-block-inner border-box">
        <div class="title">
            Search Discount Flight to <?= Html::encode($country_model->name); ?>
        </div>
