...
class Country extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['continent_id', 'first_class_price', 'business_class_price', 'first_class_old_price', 'business_class_old_price'], 'integer'],
            [['name', 'alias', 'capital_city'], 'string', 'max' => 100],
